...
Select Underlying
    ...
    Wait Until Element Is Visible   //*[@class="sc-mcd__filter__item " and contains(text(),'Forex')]
    Click Element    //*[@class="sc-mcd__filter__item " and contains(text(),'Forex')]
    Wait Until Element Is Visible    //*[@class="ic-frx ic-frxAUDUSD"]
...
Select Contract Type
    ...
    Wait Until Element Is Visible   //*[@id="dt_contract_high_low_item"]
